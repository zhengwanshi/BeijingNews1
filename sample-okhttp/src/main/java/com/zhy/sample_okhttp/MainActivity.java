...
//        url =3.125.219.144:8443/mobileConnect/MobileConnect/authLogin.action?systemid=100009&mobile=13260284063&pipe=2&reqtime=1422986580048&ispin=2";
    ...
    public void uploadFile(View view)
    {
        ...
        String url ="http://192.168.156.1:8080/FileUpload/FileUploadServlet";

        OkHttpUtils.post()//
                .addFile("mFile", "video.mp4", file)//
                .url(url)//
                .params(params)//
                .headers(headers)//
                .build()//
    ...
    public void downloadFile(View view)
    {
        ...
        url = "http://dl.image.so.com/d?imgurl=http%3A%2F%2Fp2.qhimgs4.com%2Ft0134e3ba16750b6dc8.jpg&purl=http%3A%2F%2Fsh.qihoo.com%2Fpc%2F2s21pztx71p%3Fsign%3D360_e39369d1&key=6ee4b47b44";
        OkHttpUtils//
                .get()//
                .url(url)//
                .build()//
                .execute(new FileCallBack(Environment.getExternalStorageDirectory().getAbsolutePath(), "video.mp4")//
                {
